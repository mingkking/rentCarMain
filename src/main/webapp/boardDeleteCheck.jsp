...
%>
	<h2 align="center" style="width: 600px; background: blue; color: white; ">글 삭제 비밀번호 입력</h2>
	<form action="boardDeleteCheckPro.jsp?num=<%=num %>" method="post" align="center">
		<table align="center" border="1" width="600" style="border-collapse: collapse; border-color: skyblue;">
			...
			<tr height="40px">
				<td colspan="2"><input type="submit" value="삭제 하기" style="width: 50%; background: #f0ffff;"></td>
			</tr>
			<tr height="40px">
