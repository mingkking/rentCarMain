...
%>
<div>
	<form action="rentCarMain.jsp?center=carReserveUpdatePro.jsp" method="post">
		<table align="center" width="800px" style="background: #f2f4f7; border-collapse: collapse; height: 800px;" border="1">
			<caption>
				<h2 align="center" style="width: 800px; background: blue; color: white; ">수정할 옵션 선택</h2>
			</caption>
			<tr>
				<td rowspan="15" align="center" width="200">
				...
				<td align="center" width="200">
					...
					<input type="hidden" name="carRNo" value="<%=carRNo %>">
