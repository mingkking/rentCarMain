...
%>
	<h2 align="center" style="width: 550px; background: blue; color: white; ">회원정보 수정 처리</h2>
	<table align="center" border="2px" width="550" style="border-collapse: collapse; border-color: silver;">
		...
		<tr>
			<td colspan="2" align="center"><input type="button" value="회원수정 완료" onclick="location.href='rentCarMain.jsp?center=memberJoinForm.jsp'" style="width: 50%; background: #f0ffff;"></td>	
		</tr>
	</table>
</body>
</html>