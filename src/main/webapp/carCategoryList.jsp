...
<%
	...
	vec = rdao.getCategoryCar(category);
...
%>
	<h2 align="center" style="width: 550px; background: blue; color: white; "><%=cate %> 자동차(대수: <%=vec.size() %>)</h2>
	<table align="center" width="1400" style="background: #f2f4f7; border-collapse: collapse; height: 800px;" border="1">
		<tr>
			<th>번호</th>
			<th>회사명</th>
			<th>이미지</th>
	...
	<table align="center" border="2px" style="border-collapse: collapse; border-color: silver;">
		<tr>
					<td align="center" width="100"><input type="button" value="이전" onclick="location.href='rentCarMain.jsp?page=<%=cPage-10 %>&center=carCategoryList.jsp&category=<%=category %>'" style="width: 100px; background: #f0ffff;"></td>
			<%
				for(int i=startPage; i<=endPage; i++){
			%>
					<td align="center" width="100"><a href="rentCarMain.jsp?page=<%=i %>&center=carCategoryList.jsp&category=<%=category %>"><%=i %></a></td>
			<%
				}
			%>
					<td align="center" width="100"><input type="button" value="다음" onclick="location.href='rentCarMain.jsp?page=<%=cPage+10 %>&center=carCategoryList.jsp&category=<%=category %>'" style="width: 100px; background: #f0ffff;"></td>
		</tr>
	</table>
</body>
</html>