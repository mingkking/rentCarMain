...
%>
	<h2 align="center" style="width: 550px; background: blue; color: white; ">회원정보 수정</h2>
	<form action="rentCarMain.jsp?center=memberUpdateFormPro.jsp?id=<%=id %>" method="post" align="center">
		<table align="center" border="2px" width="550" style="border-collapse: collapse; border-color: silver;">
			...
			<tr height="40px">
				...
				<td width="250"><input id="inputCss" type="text" name="tel" maxlength="20" placeholder="010-1111-2222양식으로 입력해 주세요." required></td>
			</tr>
			<tr height="40px">
			...
			<tr height="40px">
				<td colspan="2"><input type="submit" value="회원 수정" style="width: 50%; background: #f0ffff;"></td>
			</tr>
			<tr height="40px">
